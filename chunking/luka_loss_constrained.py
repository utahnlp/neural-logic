...
class LukaLoss(torch.nn.Module):
    def __init__(self, opt, shared):
        ...
        #        'B-PP implies -(I-NP)', 'B-PP implies -(I-VP)', 'B-PP implies -(I-ADVP)']
        #self.constraints = []
        # load dict entries
        self.label_str = []
    ...
    def add_constrained_loss(self, pred, gold, constraint):
    ...
    def get_luka_loss(self, pred, gold):
        ...
        return (-1 * torch.sum(correct_class_probs))


    def forward(self, pred, gold, constraints_lambda =0.01):
        ...
        for constraint in self.constraints:
            constraint_loss += -1 * self.add_constrained_loss(pred, gold, constraint)
