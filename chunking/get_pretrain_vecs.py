...
def main():
  ...
  parser.add_argument('--dir', help="The path to data dir", type=str, default='data/chunking/')
  parser.add_argument('--dict', help="*.dict file", type=str, default='chunking.word.dict')
