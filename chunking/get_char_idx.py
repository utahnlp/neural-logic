...
def main(arguments):
	...
	parser.add_argument('--dir', help="Path to the data directory", type=str, default='./data/chunking/')
	parser.add_argument('--dict', help="*.dict file", type=str, default='chunking.allword.dict')
	...
	parser.add_argument('--freq', help="The frequence bar for char to appear", type=int, default=0)
